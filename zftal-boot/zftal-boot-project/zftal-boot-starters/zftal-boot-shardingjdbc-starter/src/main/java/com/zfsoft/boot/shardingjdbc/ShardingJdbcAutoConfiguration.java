 ...
 */
package com.zfsoft.boot.shardingjdbc;
...
import com.zfsoft.boot.shardingjdbc.masterslave.MasterSlaveRuleConfigurationProperties;
import com.zfsoft.boot.shardingjdbc.sharding.ShardingRuleConfigurationProperties;
 ...
 */
@Configuration
@ConditionalOnClass({ ShardingDataSource.class, MasterSlaveDataSource.class })
	...
	public DataSource dataSource() throws SQLException {
		return null == masterSlaveProperties.getMasterDataSourceName()
				? ShardingDataSourceFactory.createDataSource(dataSourceMap,
						shardingProperties.getShardingRuleConfiguration(), shardingProperties.getConfigMap(), props)
