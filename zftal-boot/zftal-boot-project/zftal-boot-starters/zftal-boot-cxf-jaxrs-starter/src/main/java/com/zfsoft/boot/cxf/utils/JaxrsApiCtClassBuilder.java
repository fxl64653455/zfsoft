...
public class JaxrsApiCtClassBuilder implements Builder<CtClass> {

	ClassPool pool = ClassPool.getDefault();
	// 构建动态类
	private CtClass ctclass  = null;
	
	public JaxrsApiCtClassBuilder(final String classname) throws NotFoundException {
	...
	public JaxrsApiCtClassBuilder method(String apiname) throws NotFoundException, CannotCompileException {
