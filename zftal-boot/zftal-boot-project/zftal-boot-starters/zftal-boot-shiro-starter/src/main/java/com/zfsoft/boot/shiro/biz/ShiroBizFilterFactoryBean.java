package com.zfsoft.boot.shiro.biz;
...
public class ShiroBizFilterFactoryBean extends ZFShiroFilterFactoryBean implements ApplicationContextAware  {
	...
	protected boolean supports(Filter filter) {
		return 
				...
				filter instanceof PathMatchingFilter ||//
				filter instanceof LogoutFilter//
				;
	}
