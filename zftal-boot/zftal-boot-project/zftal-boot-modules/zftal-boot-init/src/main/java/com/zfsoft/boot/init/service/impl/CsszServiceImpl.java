...
import com.zfsoft.api.event.XtcsUpdateEvent;
import com.zfsoft.api.event.handler.PropsUpdateEventHandler;
...
import com.zfsoft.boot.init.dao.daointerface.ICsszDao;
...
public class CsszServiceImpl extends BaseServiceImpl<CsszModel, ICsszDao> implements ICsszService {
	...
	protected static final String DEFAULT_CACHE_NAME = "ZFTAL_XTSZ";
	protected static final String DEFAULT_CACHE_KEY = "ZFTAL_XTSZ_KEY";
	...
	/*
	 * (non-Javadoc)
	 * @see com.zfsoft.service.svcinterface.ICsszService#getValue(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.zfsoft.service.svcinterface.ICsszService#getCssz()
	 */
	@Override
