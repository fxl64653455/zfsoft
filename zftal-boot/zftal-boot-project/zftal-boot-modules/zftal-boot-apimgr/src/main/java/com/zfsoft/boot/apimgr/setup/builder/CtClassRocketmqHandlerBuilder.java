...
public class CtClassRocketmqHandlerBuilder implements Builder<CtClass> {

	ClassPool pool = ClassPool.getDefault();
	// 构建动态类
	private CtClass ctclass  = null;
	
	public CtClassRocketmqHandlerBuilder(final String classname) {
		this.ctclass = pool.makeClass(classname);
	}
	
	public CtClassRocketmqHandlerBuilder method(String apiname) throws NotFoundException, CannotCompileException {
