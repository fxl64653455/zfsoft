...
<body>
				...
				<div class="panel  text-left" style="min-height:600px;">
					<div class="tab-base tab-drop-tline">
						<ul class="nav nav-tabs"  id="nav-tabs">
							<li class="active">
								<a href="#demo-lft-tab-1">业务接口信息</a>
							</li>
							<li>
								...
								<div class="panel-body ">
									...
									<div class="form-inline col-md-8">
										<div class="form-group">
					                        <label for="query-api-name" class="control-label" style="float:left;width:70px;">接口名称：</label>
					                        <input id="query-api-name" type="text" class="form-control" style="width:240px;height:30px;border-radius:3px;float:left;" placeholder="请输入接口名称...">
					                    </div>
					                    &nbsp;
					                    <div id="btn_search" class="btn zf-btn btn-primary btn-light-primary" style="height:30px;border-radius:3px;"> 查 询 </div>
	                				</div>
	...
	<script type="text/javascript" src="${request.contextPath}/assets/js/api/info/biz/index.js?ver=${versionUtil()}"></script>
