...
<body>
    	...
    	<div class="row">
            ...
            <div class="col-sm-6">
               	<div class="form-group">
		            ...
		            <div class="col-sm-10">
			    	  	...
			    	  	[#if infoDto.type== type.key]
			    	  	<p class="form-control-static">${type.desc}</p>
			    	  	[/#if]
					    [/#list]
		            </div>
		        </div>
               	...
               	<div class="form-group">
		            ...
		            <div class="col-sm-10">
		            	[#list methodList as method] 
			    	  	[#if infoDto.method== method.key]
			    	  	<p class="form-control-static">${method.desc}</p>
			    	  	[/#if]
					    [/#list]
		            </div>
		        </div>
            </div>
            [#if infoDto.pluginId?exists]
            
            
            [#list pluginList as plugin] 
    	  	[#if infoDto.pluginId == plugin.key]
    	  	<div class="col-sm-6">
               	<div class="form-group">
		            <label for="input-plugin" class="col-sm-2 control-label">插件名称:</label>
		            <div class="col-sm-10">
			    	  	<p class="form-control-static">${plugin.value}</p>
		            </div>
		        </div>
            </div>
    	  	[/#if]
		    ...
		    <div class="col-sm-6">
               	<div class="form-group">
		            ...
		            <div class="col-sm-10">
		            	<p class="form-control-static">${extension.value}</p>
		            </div>
		        </div>
            </div>
		    [/#list]
           ...
           <div class="col-sm-12">
	            ...
	            <div class="col-sm-11">
	                <p class="form-control-static">${infoDto.url}</p>
	            </div>
	          </div>
            </div>
        	<div class="col-sm-12">
	        	...
	        	<div class="panel-body p-l-1 p-r-1 p-b-1">
					<table class="table table-condensed table-hover table-striped m-b-0">
				      	...
				      	<tbody id="table-error-tbody">
				        	...
				        	[#else]
				        	<tr>
					        	<td class="text-center p-10" colspan="4">暂无数据!</td>
					        </tr>
				        	[/#if]
				      	</tbody>
			    	</table>
    ...
    <script type="text/javascript" src="${request.contextPath}/assets/js/api/info/biz/detail.js?ver=${versionUtil()}"></script>
</body>
</html>
