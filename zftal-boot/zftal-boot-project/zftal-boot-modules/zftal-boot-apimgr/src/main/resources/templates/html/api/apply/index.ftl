...
<body>
				...
				<div class="panel  text-left" style="min-height:600px;">
					<div class="tab-base tab-drop-top">
						<ul class="nav nav-tabs">
							<li class="active">
								<a data-toggle="tab" href="#demo-drolf-tab-1" aria-expanded="true">接口申请</a>
							</li>
							<li class="">
								<a data-toggle="tab" href="#demo-drolf-tab-2" aria-expanded="false">变更历史</a>
							</li>
						</ul>
	...
	<script type="text/javascript" src="${request.contextPath}/assets/js/api/apply/index.js?ver=${versionUtil()}"></script>
	<script type="text/javascript" src="${request.contextPath}/assets/js/api/apply/change.js?ver=${versionUtil()}"></script>
</body>
</html>