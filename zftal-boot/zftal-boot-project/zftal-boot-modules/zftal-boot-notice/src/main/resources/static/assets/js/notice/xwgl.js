...
//		pager: "#pager", //分页工具栏  
//	    url: 'getXwxxList.zf', //这是Action的请求地址  
//	    autowidth : false, // 自动调整宽度
//	    colModel:[
//		     {label:'ID',name:'xwbh', index:'xwbh', key:true, hidden:true},
//		     {label:'通知标题',name:'xwbt', index: 'xwbt',align:'left',width:"400px"},
//		     {label:'发布时间',name:'fbsj', index: 'fbsj',align:'left',width:"180px"},
//	      	 {label:'发布人',name:'fbr', index: 'fbr',align:'left',width:"150px"},
//		     {label:'发布对象',name:'fbdxmcs', index: 'fbdxmcs',width:"180px",align:'center'},
//		     {label:'是否发布',name:'sffb', index: 'sffb',width:"100px",align:'center'},
//		     {label:'是否置顶',name:'sfzd', index: 'sfzd',width:"100px",align:'center'}
//		],
