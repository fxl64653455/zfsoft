...
import com.zfsoft.io.utils.FileCopyUtils;
import com.zfsoft.security.algorithm.RSACodec;
 ...
 * @time : 下午04:40:04
 */
public class DirectoryUtils extends com.zfsoft.io.utils.DirectoryUtils {
	...
	public static File getTmpDir() throws IOException {
		//获得tmpdir目录
		return getExistDir(getRootDir().getAbsolutePath()+ File.separator + MessageUtil.getText("zftal.tempPath"));
	}
