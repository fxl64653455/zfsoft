...
import com.zfsoft.api.ZFParameter;
import com.zfsoft.api.ZFParameters;
import com.zfsoft.basemodel.PairModel;
import com.zfsoft.basicutils.Assert;
 ...
 *@版本号	:v2.0.0
 */
public class WebUtils extends com.zfsoft.web.utils.WebUtils {
	...
	public static String getSessionUser(HttpServletRequest request){
		//获取当前会话中传递过来的参数
		String sessionUserKey = ZFParameters.getGlobalString(ZFParameter.REQUEST_FUNC_USERKEY);
