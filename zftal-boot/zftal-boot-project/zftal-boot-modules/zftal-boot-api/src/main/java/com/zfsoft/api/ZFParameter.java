...
public enum ZFParameter {
	...
	private ZFParameter(String name,String defaultValue) {
		this.name = name;
	...
	static ZFParameter valueOfIgnoreCase(String parameter,String defaultValue) {
		ZFParameter parm = valueOf(parameter.toUpperCase(Locale.ENGLISH).trim());
