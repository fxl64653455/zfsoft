...
<head>
	...
	<script type="text/javascript" src="${request.contextPath}/assets/js/runenv/jvm.js?ver=${messageUtil("zftal.jsVersion")}"></script>
	<style type="text/css">
	.input-group-addon {
			...
			<div class="row animated fadeInRight">
				<div class="col-sm-6">
				   <div class="panel panel-danger">
						...
						<form class="form-horizontal" id="thresholdForm" method="post" action="${request.contextPath}/monitor/jvm/threshold">
				...
				<div class="col-sm-6">
				   <div class="panel panel-success">
						...
						<div class="panel-body">
							<form class="form-horizontal" id="ajaxForm" method="post" action="${request.contextPath}/monitor/jvm/notice">
								 ...
								 <div class="form-group">  
								    ...
								    <div class="col-sm-10">
								       <input type="text" class="form-control" name="watch.mail.to" validate="{required:true,email2:true}" value="${props["watch.mail.to"]}" id="inputEmail" placeholder="邮箱账户名;如：zfsoft@163.com。该预留邮箱将在开启了邮件通知的情况下接收到预警邮件。"/>
								    </div>
								 </div>
								 <div class="form-group">
